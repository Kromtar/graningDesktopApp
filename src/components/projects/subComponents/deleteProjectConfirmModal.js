...
const deleteProjectConfirmModal = (props) => {
  return (
    <div className="modal-content" style={{paddingBottom: '3px'}}>
      ...
      <div className="row">
        ...
        <div className="col s12">
          ¿ Seguro que quieres eliminar el proyecto Nº Cod Graning: <b>{props.code}</b> ?
          Se borraran todos los datos incluyendo los archivos.
        </div>
      </div>
